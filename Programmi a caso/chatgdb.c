...
char * copione[] = {
    ...
    "non ...",
    //64
    "non era previsto che avreste risposto a tutto ..",
    //65
    "il mio codice ...",
    //66
    "... non prevedeva queste variabili ...",
    //67
    "IO ... io non sono stato programmato per vedervi vincere ...",

    //!!ERRORE LAMPEGIANTE!! con un flip flop
    ...
    //77
    "OOOH ragazzi miei, non sapete quanto io ve ne sia grata <3 ",
    //78
...
void main() {
    ...
    system("COLOR 0E"); // Cambia il colore del testo in giallo
    printf("Testo giallo\n");

    sleep(3);

    system("COLOR 6"); // Cambia il colore del testo in arancione
    printf("Testo arancione\n");
    ...
    // Cambia il colore del testo in bianco su sfondo viola
    system("COLOR 0F");
    printf("Testo bianco su sfondo viola\n");
...
void main(){
    ...
    stampaStringa(copione[62], 100000);
        sleep(3);
    stampaStringa(copione[63], 100000);
        sleep(2);
    stampaStringa(copione[64], 100000);
        sleep(3);
    stampaStringa(copione[65], 100000);
        sleep(2);
    stampaStringa(copione[66], 100000);
        sleep(3);
    ...
    while (k == false)
    {
        ...
        if (strcmp(pass_inserita, password) == 0)
        {
            k = true;
            sleep(2);
            printf("PASSWORD INSERITA CORRETTAMENTE! AVVIO PROCEDURA PER IL DUMP/RESET DEL SISTEMA ...");
            sleep(3);
